  ...
  return (
    <html lang="en" data-theme="light">
      <head>
        ...
        {/* Auth patch: removes Apple Sign-In, fixes forgot-password redirectTo */}
...
export const metadata: Metadata = {
  metadataBase: new URL(CONFIG.SITE_URL),
  title: { template: '%s | PDFKit', default: 'Free PDF Tools Online - Compress, Merge, Convert | PDFKit' },
  description: 'PDFKit is a free online PDF toolkit. Compress, merge, split, convert, sign, and edit PDFs.',
  keywords: ['pdf tools', 'compress pdf', 'merge pdf', 'pdf to word', 'free pdf editor online'],
  authors: [{ name: 'PDFKit' }],
  creator: 'PDFKit',
  robots: { index: true, follow: true },
  openGraph: {
    type: 'website', siteName: 'PDFKit', locale: 'en_IN', url: CONFIG.SITE_URL,
    title: 'Free PDF Tools Online | PDFKit',
    description: '40+ free PDF tools - compress, merge, convert, sign, edit. No signup.',
    images: [{ url: '/og-image.png', width: 1200, height: 630 }],
  },
  twitter: { card: 'summary_large_image', title: 'Free PDF Tools Online | PDFKit', images: ['/og-image.png'] },
  icons: { icon: '/favicon.ico', apple: '/apple-touch-icon.png' },
  manifest: '/site.webmanifest',
};
